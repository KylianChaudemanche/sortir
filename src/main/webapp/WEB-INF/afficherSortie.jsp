...
<div class="container">
	<div class="row">
		...
		<div class="col-md-6">
			<p>Ville organisatrice : ${sortie.getLieu().getVille().getNomVille() }</p>
			<p>Lieu : ${sortie.getLieu().getNomLieu()}</p>
			<p>Adresse : ${sortie.getLieu().getAdresse()}</p>
			<p>Code postal : ${sortie.getLieu().getVille().getCodePostal()}</p>
			<p>Latitude : ${sortie.getLieu().getLatitude()}</p>
			<p>Longitude : ${sortie.getLieu().getLongitude()}</p>
		</div>
	</div>
</div>
